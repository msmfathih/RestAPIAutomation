...
def validate_booking_reference_number(data):
    ...
    print("bookingReferenceNumber is valid")
...
def validate_job_reference_number(data):
    ...
    print("jobReferenceNumber is valid")
...
# Sample JSON payload
payload = {"data": {"orderResponse":
            {"order": {"orderItems": {"orderItem":
            [{"productInfo": {"documentDetails":
                {"documentInfo": {"documentNumber":
                "51212685", "documentType": "AWB"}, "cargoInfo":
                    {"quantityInfo": [{"piece": 1000}]}}}, "reference":
                {"bookingReferenceNumber": "50578770", "jobReferenceNumber": "49855437"}}]},
                       "orderNumber": "1740549238745"}}, "status": "success"},
